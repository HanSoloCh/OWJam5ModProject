...
namespace OWJam5ModProject
{
    public class OWJam5ModProject : ModBehaviour
    {
        ...
        const float SAND_DRAINED_HEIGHT = 145 * 2; // Sand sphere's scale is twice its radius
        const float SAND_FILLED_HEIGHT = 260 * 2;
        ...
        public const float WATER_DRAINED_HEIGHT = 140;
        const float WATER_FILLED_HEIGHT = 260;
